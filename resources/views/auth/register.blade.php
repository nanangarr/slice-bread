            ...
            <div >
                <div class="border bg-white p-8 space-y-3 "> 
                    ...
                    <div class="relative">
                        ...
                        <input type="Email" class="shadow border border-x-darkgrey py-3 pl-12 pr-3 w-full " placeholder="Username"/>
                    </div>
                    <div class="relative">
                    ...
                    <div>
                        <a href="/" > 
                            <button type="button" class="w-full bg-[#FF9F0D] transision font-semibold py-3 mb-2">Daftar
                            </button>
                        </a>
                    </div>
                    <div>

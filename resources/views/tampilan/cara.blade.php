...
<div class="container mx-auto pt-8">
            <div id="order" class=" md:min-h-fit min-h-[60vh] flex justify-between items-start mb-4 py-4 px-8">
                ...
                <div class="w-full md:w-1/2 pr-20">
                        ...
                        <div id="accordion-flush-body-1" class="hidden" aria-labelledby="accordion-flush-heading-1">
                            <div class="py-5 border-b border-gray-200 dark:border-gray-700">
                                <ul class="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
                                    ...
                                    <li>Setelah memilih produk, klik tombol "Pesan via WhatsApp" yang ada di halaman
                                        produk.</li>
                                    <li>Kamu akan diarahkan ke aplikasi WhatsApp dengan pesan otomatis berisi detail
                                        produk. Cukup
                                        kirimkan pesan tersebut kepada kami.</li>
                                    <li>Tim kami akan segera mengonfirmasi pesananmu melalui WhatsApp.</li>
                                    <li>Setelah pesanan dikonfirmasi, lakukan pembayaran sesuai instruksi yang
                                        diberikan.</li>
                                </ul>
                            </div>
                        </div>

...
@section('content')
    <div class="container mx-auto px-20 py-8">
                        ...
                        <tr class="text-gray-700 dark:text-black">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex justify-center">
                                    <img class="h-32 w-32 object-cover rounded-lg" src="@/assets/images/misc/RotiAnggur.jpg"
                                        alt="" loading="lazy" />
                                </div>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex justify-center">
                                    <a href="/delete" class="text-red-500 hover:text-red-700 transition-colors duration-200"
                                        aria-label="Delete" @click.prevent="confirmDelete()">
        ...
        <div class="flex space-y-6 lg:mt-0 lg:w-full">
            <div
                class="mt-20 space-y-4 w-[648px] rounded-lg border border-x-mediumgrey bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
